 ...
 * </p>
 * <code>
 * tornado -jar tornado-benchmarks/target/jmhbenchmarks.jar uk.ac.manchester.tornado.benchmarks.bfs.JMHBFS
 * </code>
 */
public class JMHBFS {
    ...
    @Fork(1)
    public void bfsJava(BenchmarkSetup state) {
        ComputeKernels.bfs(state.verticesJava, state.adjacencyMatrix, state.size, state.modifyJava, state.currentDepth);
    }
    ...
    @OutputTimeUnit(TimeUnit.NANOSECONDS)
    @Fork(1)
    public void bfsTornado(BenchmarkSetup state, Blackhole blackhole) {
