 ...
 * </p>
 * <code>
 * tornado -jar tornado-benchmarks/target/jmhbenchmarks.jar uk.ac.manchester.tornado.benchmarks.blackAndWhiteFilter.JMHBlackAndWhiteFilter
 * </code>
 */
public class JMHBlackAndWhiteFilter {
    ...
    @Fork(1)
    public void blackAndWhiteFilterJava(BenchmarkSetup state) {
        ComputeKernels.blackAndWhiteCompute(state.imageRGB, state.size, state.size);
    }
    ...
    @OutputTimeUnit(TimeUnit.NANOSECONDS)
    @Fork(1)
    public void blackAndWhiteFilterTornado(BenchmarkSetup state, Blackhole blackhole) {
    ...
    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder() //
                .include(JMHBlackAndWhiteFilter.class.getName() + ".*") //
