 ...
 * </p>
 * <code>
 * tornado -jar tornado-benchmarks/target/jmhbenchmarks.jar uk.ac.manchester.tornado.benchmarks.matrixMultiplication1D.JMHMatrixMultiplication1D
 * </code>
 */
public class JMHMatrixMultiplication1D {
    ...
    public static class BenchmarkSetup {
        ...
        public void doSetup() {
            ...
            TaskGraph taskGraph = new TaskGraph("benchmark") //
                    ...
                    .task("matrixVectorMultiplication", LinearAlgebraArrays::matrixMultiplication, a, b, c, size) //
    ...
    @Fork(1)
    public void matrixMultiplicationJava(BenchmarkSetup state) {
        matrixMultiplication(state.a, state.b, state.c, state.size);
    }
    ...
    @OutputTimeUnit(TimeUnit.NANOSECONDS)
    @Fork(1)
    public void matrixMultiplicationTornado(BenchmarkSetup state, Blackhole blackhole) {
    ...
    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder() //
                .include(JMHMatrixMultiplication1D.class.getName() + ".*") //
