 ...
 * </p>
 * <code>
 * tornado -jar tornado-benchmarks/target/jmhbenchmarks.jar uk.ac.manchester.tornado.benchmarks.matrixMultiplication2D.JMHMatrixMultiplication2D
 * </code>
 */
public class JMHMatrixMultiplication2D {
    ...
    public static class BenchmarkSetup {
        ...
        public void doSetup() {
            ...
            TaskGraph taskGraph = new TaskGraph("benchmark") //
                    ...
                    .task("matrixMultiplication2D", LinearAlgebraArrays::matrixMultiplication, a, b, c, size) //
    ...
    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder() //
                .include(JMHMatrixMultiplication2D.class.getName() + ".*") //
