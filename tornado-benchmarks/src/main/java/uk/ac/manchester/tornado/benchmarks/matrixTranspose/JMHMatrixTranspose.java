...
public class JMHMatrixTranspose {
    ...
    public static class BenchmarkSetup {
        ...
        public void doSetup() {
            ...
            TaskGraph taskGraph = new TaskGraph("benchmark") //
                    ...
                    .task("matrixTranspose", LinearAlgebraArrays::matrixTranspose, a, b, size) //
    ...
    @Fork(1)
    public void matrixTransposeJava(BenchmarkSetup state) {
        matrixTranspose(state.a, state.b, state.size);
    }
    ...
    @OutputTimeUnit(TimeUnit.NANOSECONDS)
    @Fork(1)
    public void matrixTransposeTornado(BenchmarkSetup state, Blackhole blackhole) {
    ...
    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder() //
                .include(JMHMatrixTranspose.class.getName() + ".*") //
