...
public class MaxReductionGlobalJava extends BenchmarkDriver {

    private int size;
    IntArray arrayA;

    public MaxReductionGlobalJava(int iterations, int size) {
        super(iterations);
        this.size = size;
    }
    ...
    public void runBenchmark(TornadoDevice device) {
        ComputeReductions.computeMaxSequential(arrayA);
    }
}
