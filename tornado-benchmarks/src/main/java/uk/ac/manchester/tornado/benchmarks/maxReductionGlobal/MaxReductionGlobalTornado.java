 ...
 * </p>
 * <code>
 * tornado -m tornado.benchmarks/uk.ac.manchester.tornado.benchmarks.BenchmarkRunner maxReductionGlobal
 * </code>
 */
public class MaxReductionGlobalTornado extends BenchmarkDriver {
    ...
    public MaxReductionGlobalTornado(int iterations, int size) {
        super(iterations);
        this.size = size;
    }
    ...
    public boolean validate(TornadoDevice device) {
        ...
        taskGraph = new TaskGraph("benchmark") //
                .transferToDevice(DataTransferMode.EVERY_EXECUTION, arrayA) //
                .task("maxReductionGlobal", ComputeReductions::intReductionMaxGlobalMemory, context, arrayA, resultParallel) //
