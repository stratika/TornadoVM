 ...
 * </p>
 * <code>
 * tornado -jar tornado-benchmarks/target/jmhbenchmarks.jar uk.ac.manchester.tornado.benchmarks.maxReductionLocal.JMHMaxReductionLocal
 * </code>
 */
public class JMHMaxReductionLocal {
    ...
    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder() //
                .include(JMHMaxReductionLocal.class.getName() + ".*") //
