 ...
 * </p>
 * <code>
 * tornado -jar tornado-benchmarks/target/jmhbenchmarks.jar uk.ac.manchester.tornado.benchmarks.vectorAddition.JMHVectorAddition
 * </code>
 */
public class JMHVectorAddition {
    ...
    @Fork(1)
    public void vectorAdditionJava(BenchmarkSetup state) {
    ...
    @OutputTimeUnit(TimeUnit.NANOSECONDS)
    @Fork(1)
    public void vectorAdditionTornado(BenchmarkSetup state, Blackhole blackhole) {
    ...
    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder() //
                .include(JMHVectorAddition.class.getName() + ".*") //
